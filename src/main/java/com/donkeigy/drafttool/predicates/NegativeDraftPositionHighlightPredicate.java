 ...
 */
public class NegativeDraftPositionHighlightPredicate implements HighlightPredicate
{
    private Map<String, FantasyFootballADP> averageDraftPositionMap;

    public NegativeDraftPositionHighlightPredicate( Map<String, FantasyFootballADP> averageDraftPositionMap) {
        super();
